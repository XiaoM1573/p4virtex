...
public class Srv6InterpreterImpl extends AbstractHandlerBehaviour
    ...
    private static final Map<Criterion.Type, PiMatchFieldId> CRITERION_MAP =
            new ImmutableMap.Builder<Criterion.Type, PiMatchFieldId>()
                    ...
                    .put(Criterion.Type.IPV6_DST, HDR_HDR_IPV6_DST_ADDR)
                    .build();

    private static final Map<Integer, PiTableId> TABLE_MAP =
            new ImmutableMap.Builder<Integer, PiTableId>()
                    .put(0, INGRESS_TABLE0_CONTROL_TABLE0)
                    .put(1, INGRESS_TABLES_CONTROL_LOCAL_SID_TABLE)
                    .put(2, INGRESS_TABLES_CONTROL_TRANSIT_TABLE)
                    .put(3, INGRESS_TABLES_CONTROL_ROUTING_V6_TABLE)
                    .build();
        ...
        switch (instruction.type()) {
            case OUTPUT:
                if (piTableId.equals(INGRESS_TABLE0_CONTROL_TABLE0)) {
                    return outputPiAction((Instructions.OutputInstruction) instruction, INGRESS_TABLE0_CONTROL_SET_EGRESS_PORT);
                } else {
