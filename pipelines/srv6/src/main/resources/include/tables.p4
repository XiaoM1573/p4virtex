...
control tables_control(inout headers_t hdr,
    ...
    action insert_segment_list_2(ipv6_address_t s1, ipv6_address_t s2){
    ...
    action insert_segment_list_3(ipv6_address_t s1, ipv6_address_t s2, ipv6_address_t s3){
        hdr.ipv6.dst_addr = s1;
    ...
    action insert_segment_list_4(ipv6_address_t s1, ipv6_address_t s2, ipv6_address_t s3, ipv6_address_t s4){
        hdr.ipv6.dst_addr = s1;
    ...
    action insert_segment_list_5(ipv6_address_t s1, ipv6_address_t s2, ipv6_address_t s3, ipv6_address_t s4, ipv6_address_t s5){
        hdr.ipv6.dst_addr = s1;
