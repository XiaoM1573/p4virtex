...
public class TunnelService {
    ...
    private void insertTunnelIngressRule(DeviceId switchId, Ip6Address dstIpAddr, List<Link> candidates) {
    ...
    public void insertLocalSid(DeviceId deviceId, Ip6Address ip6Address) {
        PiTableId tableId = PiTableId.of("ingress.tables_control.local_sid_table");
        ...
        PiActionId actionId = PiActionId.of("ingress.tables_control.end");
    ...
    public void insertTransitRule(DeviceId deviceId, Ip6Prefix ip6Prefix, List<Ip6Address> segmentList) {
        PiTableId tableId = PiTableId.of("ingress.tables_control.transit_table");
        ...
        PiActionId actionId = PiActionId.of("ingress.tables_control.insert_segment_list_" + (segmentList.size() + 1));
    ...
    public void insertRoutingRule(DeviceId deviceId, Ip6Prefix ip6Prefix, PortNumber outputPort) {
        PiTableId tableId = PiTableId.of("ingress.tables_control.routing_v6_table");
        ...
        PiActionId actionId = PiActionId.of("ingress.tables_control.to_port");
